...
public class ChildAgeRestriction {

    @SuppressWarnings("resource")
    @DataProvider(name="PBD10788ChildAgeRestriction")
    public static Object[][] getData() throws IOException{//Getting data from excel
        Object[][] testData;//string -group of string in 2D
        FileInputStream	fis=new FileInputStream("./testData/ChildAgeRestriction.xlsx");

...
public class DpNine {
    ...
    @DataProvider(name="TC009SupplierPortalEndToEndTestcase")
    public static Object[][] getData() throws IOException{//Getting data from excel
        Object[][] testData;//string -group of string in 2D
        FileInputStream	fis=new FileInputStream("./testData/TC009SupplierPortalEndToEndTestcase.xlsx");
        ...
        System.out.println("Column count="+coulumnCount);

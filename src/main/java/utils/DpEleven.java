...
public class DpEleven {
    ...
    @DataProvider(name="TC011CreateRoomWithCancellationPolicySameDayOfArrival")
    public static Object[][] getData() throws IOException{//Getting data from excel
        Object[][] testData;//string -group of string in 2D
        FileInputStream	fis=new FileInputStream("./testData/TC011CreateRoomWithCancellationPolicySameDayOfArrival.xlsx");

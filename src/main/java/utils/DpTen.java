...
public class DpTen {
    ...
    @DataProvider(name="TC010CreateRoomWithNoCancellationPolicy")
    public static Object[][] getData() throws IOException{//Getting data from excel
        Object[][] testData;//string -group of string in 2D
        FileInputStream	fis=new FileInputStream("./testData/TC010CreateRoomWithNoCancellationPolicy.xlsx");
